...
-- AddForeignKey
ALTER TABLE "offered_courses" ADD CONSTRAINT "offered_courses_departmentId_fkey" FOREIGN KEY ("departmentId") REFERENCES "departments"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
