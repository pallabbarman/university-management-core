...
CREATE TABLE "Department " (
    ...
    CONSTRAINT "Department _pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Department " ADD CONSTRAINT "Department _academicFacultyId_fkey" FOREIGN KEY ("academicFacultyId") REFERENCES "academicfaculties"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "faculties" ADD CONSTRAINT "faculties_departmentId_fkey" FOREIGN KEY ("departmentId") REFERENCES "Department "("id") ON DELETE RESTRICT ON UPDATE CASCADE;
