...
import { IStudentEnrolledCourseMarkFilter } from './interface';
import { calcCGPAandGrade, getGradeFromMarks } from './utils';

export const createStudentEnrolledCourseDefaultMark = async (
    prismaClient: Omit<
...
export const findAllStudentEnrolledCourseMarks = async (
...
export const editStudentMarks = async (payload: any) => {
...
export const editFinalMarks = async (payload: any) => {
    ...
    const academicResult = await calcCGPAandGrade(grades);
...
export const findMyCourseMarks = async (
    filters: IStudentEnrolledCourseMarkFilter,
    options: IPaginationOptions,
    authUser: any
): Promise<IGenericResponse<StudentEnrolledCourseMark[]>> => {
