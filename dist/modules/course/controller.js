...
exports.deleteFaculties = exports.assignFaculties = exports.deleteCourse = exports.updateCourse = exports.getCourse = exports.getAllCourses = exports.createCourse = void 0;
...
exports.assignFaculties = (0, catchAsync_1.default)(async (req, res) => {
    const id = req.params?.id;
    const result = await (0, service_1.setFaculties)(id, req.body?.faculties);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
exports.deleteFaculties = (0, catchAsync_1.default)(async (req, res) => {
    const id = req.params?.id;
    const result = await (0, service_1.removeFaculties)(id, req.body?.faculties);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
